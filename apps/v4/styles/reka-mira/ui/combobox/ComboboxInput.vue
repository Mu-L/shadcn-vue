...
<template>
  <InputGroup>
    <InputGroupAddon>
      <IconPlaceholder lucide="SearchIcon" tabler="IconSearch" hugeicons="Search01Icon" phosphor="MagnifyingGlassIcon" remixicon="RiSearchLine" class="size-3.5 shrink-0 opacity-50" />
    </InputGroupAddon>
    <ComboboxInput
